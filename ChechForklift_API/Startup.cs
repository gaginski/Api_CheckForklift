using ChechForklift.Api;
using CheckForklift.Api.Security;
using CheckForklift.IoC.Unity;
...
namespace CheckForklift.Api
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            Instance.Current.ServerDB = "DESKTOP-AVV1N1R";
            Instance.Current.UserDB = "sa";
            Instance.Current.SenhaDB = "root";
            Instance.Current.DataBaseNome = "CheckForklift";
            // Swagger
